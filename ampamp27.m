...
%% 2nd condition
% n1 = length(EstimatedRef); 
% if EstimatedRef(1) < 100 & EstimatedRef > -100
%     if (ClosestAntenna>SecondClosestAntenna & ~(ClosestAntenna==4 & SecondClosestAntenna == 1)) | (ClosestAntenna==1 & SecondClosestAntenna ==4)
%         EstimatedRefs=EstimatedRef(1:floor(n1/2));
%     else
%         EstimatedRefs=EstimatedRef(floor(n1/2):n1);
%     end
% else
%     if (ClosestAntenna>SecondClosestAntenna & ~(ClosestAntenna==4 & SecondClosestAntenna == 1)) | (ClosestAntenna==1 & SecondClosestAntenna ==4)
%         EstimatedRefs=EstimatedRef(floor(n1/2):n1);
...
%% OG condition
% 
% if (ClosestAntenna>SecondClosestAntenna & ~(ClosestAntenna==3 & SecondClosestAntenna == 4)) | (ClosestAntenna==4 & SecondClosestAntenna ==3)
%         EstimatedRefs=EstimatedRef(1:floor(n1/2));
%     else
%         EstimatedRefs=EstimatedRef(floor(n1/2):n1);
%     end
